...
Plans are stored using a flexible and scalable structure that allows multiple activities per plan and future user-based features.
...
```json
{
  "plans": {
    "planId": {
      ...
      "city": "Bilbao",
      "coverImg": "https://...",
      "description": "A weekend exploring local food spots",
      "likes": {
        "userId1": true,
        "userId2": true
      },
...
VITE_FB_DATABASE_URL=tu_db_url
